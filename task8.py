''' 2 input alacaqsınız. Birində rəqəmlər və digərində rəqəmlərin uyğun gələcəyi nömrə yazılışı olacaq. Həmin nömrə yazılışı içərisindəki diezləri verilən rəqəmlərlə əvəzləməlisiniz.'''
    
# num = input("Rəqəmləri daxil edin: ")
# format = input("Nömrənin yazılışını daxil edin: ")
